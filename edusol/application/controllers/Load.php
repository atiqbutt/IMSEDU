...
public function student($cl=0,$se=0)
    ...
    public function studentClassWise($cl='')
    {
        
            if(!empty($cl))
            {
                    $branch=$this->user_model->getbranch();
               $result = $this->db->query("select student.id,student.student_name,student.grno from `student` inner join `promotion` on student.id=promotion.student_id where promotion.class_id='$cl' AND promotion.is_active='1' AND student.status='0' AND student.branch='$branch'")->result_array();
...
//var_dump($result);die;
    ...
    public function studentagainstclass($value=0)
    {
        ...
        $this->db->where('pro.is_active',1)->where('pro.is_delete',0);
...
$this->db->join('section', 'section.section_id=pro.section_id')->where('student.status',0)->where('pro.class_id',$value)
 ...
 public function subject_class($c="")
   ...
   public function subject_sectionwise($c="",$s="")
    {
       if(!empty($c) && !empty($s))
        {
           $result = $this->db->query("SELECT `id`,`name` FROM `subject` WHERE `class_id`='$c' AND `section_id`='$s' AND `is_deleted`=0 ")->result_array();
            foreach ($result as $key => $value) {
               echo "<option value='".$value['id']."'>".$value['name']."</option>";
            }
        }
 ...
 //=======================================================================Load subject according to class======================================
    ...
    public function subject($c="",$sec="")
    {
      
        if(!empty($c))
        {

             //$section = $this->db->query("SELECT * FROM `section` WHERE `class_id`='$c' AND `is_delete`=0 limit 1")->row_array();
                // $sid=$section['section_id'];

            $result = $this->db->query("SELECT `id`,`name` FROM `subject` WHERE `class_id`='$c' AND `section_id`='$sec'  AND `is_deleted`=0")->result_array();
            foreach ($result as $key => $value) {
                echo "<option value='".$value['id']."'>".$value['name']."</option>";
            }
        }
  ...
  public function subject_section($c="",$sec="")
    {
    ...
    public function exam($c="")
    {
        if(!empty($c))
        {
            $result = $this->db->query("SELECT `id`,`name` FROM `exam` WHERE `class_id`='$c' and is_delete=0")->result_array();
            foreach ($result as $key => $value) {
                echo "<option value='".$value['id']."'>".$value['name']."</option>";
            }
        }
...
public function subjectt($c="20")
{
$section = $this->db->query("SELECT * FROM `section` WHERE `class_id`='$c' AND `is_delete`=0 ORDER BY section_id DESC limit 1")->row_array();
 var_dump($section);
die();
}
...
public function subjectforpaper($c="")
 ...
 //$section = $this->db->query("SELECT * FROM `section` WHERE `class_id`='$c' AND `is_delete`=0 limit 1")->row_array();
            ...
            $result = $this->db->query("SELECT `id`,`name` FROM `subject` WHERE `class_id`='$c' AND `section_id`='$sid'  AND `is_deleted`=0")->result_array();
            foreach ($result as $key => $value) {
                echo "<option value='".$value['id']."'>".$value['name']."</option>";
            }
        }
...
public function chapter($v="", $class="")
    {
            ...
            if(!empty($v))
            {
                ...
                $result = $this->db->query("SELECT `id`,`name`,`chapterNo` FROM `chapters` WHERE `subject_id`='$v'  AND `class_id`=$class AND is_delete=0 ")->result_array();
                //var_dump($result);die();
                foreach ($result as $key => $value) {
...
//=========================================Class wise grammer===================================================
public function grammer_questionagainstclass($id=0,$type=0)
    {
           if(!empty($id))
             {
                $this->db->select('general_questions.grammer,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
                $this->db->from('general_questions');
                $this->db->join('class','general_questions.class=class.class_id');
                $this->db->join('chapters','general_questions.chapter=chapters.id');
                $this->db->join('subject','general_questions.subject=subject.id');
...
//=======================Subject wise Load view of grammer questions================================
    public function grammer_questionagainstsubject($id=0,$idsub=0,$type=0)
    {
            if(!empty($id))
             {
                 $result = $this->db->query("SELECT general_questions.id,general_questions.grammer,general_questions.level,class.class_name,subject.name as sub,chapters.name as chap FROM `general_questions` INNER JOIN class ON general_questions.class=class.class_id INNER JOIN subject ON general_questions.subject=subject.id INNER JOIN  chapters on chapters.id=general_questions.chapter WHERE general_questions.is_delete='0' AND general_questions.class='$id'  AND general_questions.subject='$idsub' AND general_questions.question_type='$type' ")->result_array();
                 $return="";
...
//==================================grammer chapter wise Questions filtration part=========================================
    public function grammer_questionagainstchapter($id=0,$sub=0,$chapter=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.grammer,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
...
//==================================Level wise grammer=========================================
    public function grammer_questionagainstlevel($id=0,$sub=0,$chapter=0,$level="",$type=0)
    {
            if(!empty($id))
             {
                $level=urldecode($level);
                ...
                $i=1;
                 foreach ($result as $key => $value) {
                        ...
                        $return .= "<td>".$value['chap']."</td>";
                        $return .= "<td>".$value['level']."</td>";
                        $return .= "<td><a href='".base_url()."autopaper/delete_question/general_questions/".$value['id']."'><i class='fa fa-trash'></i></a></td>";
             $return .= "</tr>";    
                 }
                 echo $return;
            }
...
$result=$this->db->query("SELECT `id`,`name`,`chapterNo` FROM `chapters` WHERE `subject_id`='$idsub'  AND `class_id`=$id AND is_delete=0 ")->result_array();
                 $return="";
                 $i=1;
                 foreach ($result as $key => $value) {
              ...
              <input name='chapter[]' class='ch' type='checkbox' value=".$value['id'].">".$value['name']."     --".$value['chapterNo']." </div>";
...
/*==================================================================================================*/
  ...
  public function stop_student($id=0)
      ...
      public function checkdate($val="0000-00")
    {
      ...
      public function questions_checked($class=0,$branch=0,$subject=0,$level=0)
    {
        $chapter=$this->input->get('ch_checked');
        $this->db->select("question_type as type,count(id) AS total");
        $this->db->from('general_questions');
        ...
        $general=$this->db->get()->result_array();
    //=====================long=======================
        $this->db->select("count(id) AS total_long");
        ...
        $this->db->where('level',$level);
        $this->db->where_in('chapter',$chapter);
        $long=$this->db->get()->row_array();

//=====================passage=======================

       $set_result=$this->db->select('*')
                            ->FROM('passage')
                             ->where('branch',$branch)
                             ->where('class',$class)
                              ->where('subject',$subject)
                              ->where('level',$level)
                              ->where_in('chapter',$chapter)
                             ->order_by('rand()')
                              ->LIMIT(1)
                               -> get();
             $slt_query['get_data']=$set_result->row_array(); 


       $this->session->set_flashdata('passage_id',$slt_query['get_data']['id']);

       
      $this->db->select("count(id) AS total_passage");
        $this->db->from('general_questions');
        $this->db->where('class',$class);
        $this->db->where('subject',$subject);
        $this->db->where('branch',$branch);
        $this->db->where('level',$level);
         $this->db->where('passage_id',$slt_query['get_data']['id']);
        $this->db->where_in('chapter',$chapter);
        $pass=$this->db->get()->row_array();

        //======================short=================
        $this->db->select("count(id) AS total_short");
        ...
        $this->db->where('level',$level);
        $this->db->where_in('chapter',$chapter);
        $short=$this->db->get()->row_array();
        //======================mcq=================
        $this->db->select("count(id) AS total_mcq");
        ...
        $this->db->where('level',$level);
        $this->db->where_in('chapter',$chapter);
        $mcq=$this->db->get()->row_array();
        //var_dump('<pre>',$long);die();
        $data=array();

        array_push($data,$mcq,$short,$long,$general,$pass);
...
//=========================================Class wise Masculine===================================================
public function mf_questionagainstclass($id=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.masculine,general_questions.feminine,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
                $this->db->from('general_questions');
                $this->db->join('class','general_questions.class=class.class_id');
                $this->db->join('chapters','general_questions.chapter=chapters.id');
                $this->db->join('subject','general_questions.subject=subject.id');
                ...
                $return="";
                 ...
                 foreach ($result as $key => $value) {
                    $return .= "<tr>";
                    $return .= "<td>".$i++."</td>";
                    $return .= "<td>".$value['masculine']." </td>";
                    $return .= "<td>".$value['feminine']." </td>";
                    $return .= "<td>".$value['class_name']." </td>";
                    $return .= "<td>".$value['sub']." </td>";
                    $return .= "<td>".$value['chap']."</td>";
                    $return .= "<td>".$value['level']."</td>";
                    $return .= "<td><a href='".base_url()."autopaper/delete_question/general_questions/".$value['id']."'><i class='fa fa-trash'></i></a><a href='".base_url()."autopaper/edit_mf/".$value['id']."'><i class='fa fa-edit'></i></a></td>";
             $return .= "</tr>";
...
//=======================Subject wise of masculine questions================================
    public function mf_questionagainstsubject($id=0,$idsub=0, $type=0)
    {
            if(!empty($id))
             {
                 $result = $this->db->query("SELECT general_questions.id,general_questions.masculine,general_questions.feminine,general_questions.level,class.class_name,subject.name as sub,chapters.name as chap FROM `general_questions` INNER JOIN class ON general_questions.class=class.class_id INNER JOIN subject ON general_questions.subject=subject.id INNER JOIN  chapters on chapters.id=general_questions.chapter WHERE general_questions.is_delete='0' AND general_questions.class='$id'  AND general_questions.subject='$idsub' AND general_questions.question_type='$type' AND general_questions.is_delete=0 ")->result_array();
                 $return="";
...
//==================================Chapter wise Masculine=========================================
    public function mf_questionagainstchapter($id=0,$sub=0,$chapter=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.masculine,general_questions.feminine,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
...
//==================================Level wise masculine========================================
    public function mf_questionagainstlevel($id=0,$sub=0,$chapter=0,$level="",$type=0)
    {
            if(!empty($id))
             {
                $level=urldecode($level);
...
//=========================================Class wise proverb===================================================
public function proverb_questionagainstclass($id=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.pro_verb,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
                $this->db->from('general_questions');
                $this->db->join('class','general_questions.class=class.class_id');
                $this->db->join('chapters','general_questions.chapter=chapters.id');
                $this->db->join('subject','general_questions.subject=subject.id');
                ...
                $return="";
                 ...
                 foreach ($result as $key => $value) {
                    $return .= "<tr>";
                    $return .= "<td>".$i++."</td>";
                    $return .= "<td>".$value['pro_verb']." </td>";
                    $return .= "<td>".$value['class_name']." </td>";
                    $return .= "<td>".$value['sub']." </td>";
                    $return .= "<td>".$value['chap']."</td>";
                    $return .= "<td>".$value['level']."</td>";
                    $return .= "<td><a href='".base_url()."autopaper/delete_question/general_questions/".$value['id']."'><i class='fa fa-trash'></i></a><a href='".base_url()."autopaper/edit_proverb/".$value['id']."'><i class='fa fa-edit'></i></a></td>";
             $return .= "</tr>"; 
...
//=========================================Class wise conservation===================================================
public function conservation_questionagainstclass($id=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.conversation,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
                $this->db->from('general_questions');
                $this->db->join('class','general_questions.class=class.class_id');
                $this->db->join('chapters','general_questions.chapter=chapters.id');
                $this->db->join('subject','general_questions.subject=subject.id');
                ...
                $return="";
                 ...
                 foreach ($result as $key => $value) {
                    $return .= "<tr>";
                    $return .= "<td>".$i++."</td>";
                    $return .= "<td>".$value['conversation']." </td>";
                    $return .= "<td>".$value['class_name']." </td>";
                    $return .= "<td>".$value['sub']." </td>";
                    $return .= "<td>".$value['chap']."</td>";
                    $return .= "<td>".$value['level']."</td>";
                    $return .= "<td><a href='".base_url()."autopaper/delete_question/general_questions/".$value['id']."'><i class='fa fa-trash'></i></a><a href='".base_url()."autopaper/edit_conversation/".$value['id']."'><i class='fa fa-edit'></i></a></td>";
             $return .= "</tr>"; 
...
//=========================================Class wise passage===================================================
public function passage_questionagainstclass($id=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.passage,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
                $this->db->from('general_questions');
                $this->db->join('class','general_questions.class=class.class_id');
                $this->db->join('chapters','general_questions.chapter=chapters.id');
                $this->db->join('subject','general_questions.subject=subject.id');
                ...
                $return="";
                 ...
                 foreach ($result as $key => $value) {
                    $return .= "<tr>";
                    $return .= "<td>".$i++."</td>";
                    $return .= "<td>".$value['passage']." </td>";
                    $return .= "<td>".$value['class_name']." </td>";
                    $return .= "<td>".$value['sub']." </td>";
                    $return .= "<td>".$value['chap']."</td>";
                    $return .= "<td>".$value['level']."</td>";
                    $return .= "<td><a href='".base_url()."autopaper/delete_question/general_questions/".$value['id']."'><i class='fa fa-trash'></i></a><a href='".base_url()."autopaper/edit_passage/".$value['id']."'><i class='fa fa-edit'></i></a></td>";
             $return .= "</tr>"; 
...
//=======================Subject wise of proverb questions================================
    public function proverb_questionagainstsubject($id=0,$idsub=0, $type=0)
    {
            if(!empty($id))
             {
                 $result = $this->db->query("SELECT general_questions.id,general_questions.pro_verb,general_questions.level,class.class_name,subject.name as sub,chapters.name as chap FROM `general_questions` INNER JOIN class ON general_questions.class=class.class_id INNER JOIN subject ON general_questions.subject=subject.id INNER JOIN  chapters on chapters.id=general_questions.chapter WHERE general_questions.is_delete='0' AND general_questions.class='$id'  AND general_questions.subject='$idsub' AND general_questions.question_type='$type' ")->result_array();
                 $return="";
...
//=======================Subject wise of conservation questions================================
    public function conservation_questionagainstsubject($id=0,$idsub=0, $type=0)
    {
            if(!empty($id))
             {
                 $result = $this->db->query("SELECT general_questions.id,general_questions.conversation,general_questions.level,class.class_name,subject.name as sub,chapters.name as chap FROM `general_questions` INNER JOIN class ON general_questions.class=class.class_id INNER JOIN subject ON general_questions.subject=subject.id INNER JOIN  chapters on chapters.id=general_questions.chapter WHERE general_questions.is_delete='0' AND general_questions.class='$id'  AND general_questions.subject='$idsub' AND general_questions.question_type='$type' ")->result_array();
                 $return="";
...
//=======================Subject wise of passage questions================================
    public function passage_questionagainstsubject($id=0,$idsub=0, $type=0)
    {
            if(!empty($id))
             {
                 $result = $this->db->query("SELECT general_questions.id,general_questions.passage,general_questions.level,class.class_name,subject.name as sub,chapters.name as chap FROM `general_questions` INNER JOIN class ON general_questions.class=class.class_id INNER JOIN subject ON general_questions.subject=subject.id INNER JOIN  chapters on chapters.id=general_questions.chapter WHERE general_questions.is_delete='0' AND general_questions.class='$id'  AND general_questions.subject='$idsub' AND general_questions.question_type='$type' ")->result_array();
                 $return="";
...
//==================================Chapter wise proverb=========================================
    public function proverb_questionagainstchapter($id=0,$sub=0,$chapter=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.pro_verb,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
...
//==================================Chapter wise conservation=========================================
    public function conservation_questionagainstchapter($id=0,$sub=0,$chapter=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.conversation,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
...
//==================================Chapter wise passage=========================================
    public function passage_questionagainstchapter($id=0,$sub=0,$chapter=0,$type=0)
    {
            if(!empty($id))
             {
                $this->db->select('general_questions.passage,general_questions.id,general_questions.level,class.class_name,subject.name as sub, chapters.name as chap');
 ...
 //==================================Level wise proverb=========================================
    public function proverb_questionagainstlevel($id=0,$sub=0,$chapter=0,$level="",$type=0)
    {
            if(!empty($id))
             {
                $level=urldecode($level);
 ...
 //==================================Level wise conservation=========================================
    public function conservation_questionagainstlevel($id=0,$sub=0,$chapter=0,$level="",$type=0)
    {
            if(!empty($id))
             {
                $level=urldecode($level);
 ...
 //==================================Level wise passage=========================================
    public function passage_questionagainstlevel($id=0,$sub=0,$chapter=0,$level="",$type=0)
    {
            if(!empty($id))
             {
                $level=urldecode($level);
