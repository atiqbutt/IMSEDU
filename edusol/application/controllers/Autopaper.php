...
public function get_question()
{
         ...
         if($value==1)
          ...
          }elseif($value==20)
          {
            $this->load->view('header',$data);
            $this->load->view('sidebar',$data);
            $this->load->view('autopaper/grammer',$data);
          }
         elseif($value==21)
          {
            $this->load->view('header',$data);
            $this->load->view('sidebar',$data);
            $this->load->view('autopaper/masculine_feminine',$data);
          }elseif($value==22)
          {
            $this->load->view('header',$data);
            $this->load->view('sidebar',$data);
            $this->load->view('autopaper/proverb',$data);
          }elseif($value==23)
          {
            $this->load->view('header',$data);
            $this->load->view('sidebar',$data);
            $this->load->view('autopaper/conversation',$data);
          }elseif($value==24)
          {
            $this->load->view('header',$data);
            $this->load->view('sidebar',$data);
            $this->load->view('autopaper/passage',$data);
          }else
          {
...
//=================================save masculine and feminine question=====================================
public function save_masculine_feminine()
{
  if($this->input->post())
    {
      $data=$this->input->post();
...
//==================================save Word for proverb===========================
public function save_proverb()
{
  if($this->input->post())
    {
      $data=$this->input->post();
...
//==================================save Word for conservation===========================
public function save_conservation()
{
  if($this->input->post())
    {
      $data=$this->input->post();
...
public function edit_proverb()
  {
    if($this->uri->segment(3))
    {
      ...
      if($this->user_model->is_super())
              ...
              $this->load->view('header',$data);
              $this->load->view('sidebar',$data);
              $this->load->view('autopaper/edit_proverb',$data);    
    }
  }
  
  //================================Save edit data of Make Sentence to Words===========================
public function save_edit_proverb()
{
     if($this->input->post()){
        $data = $this->input->post();
        $db_insert = $this->autopaper_model->save_edit_proverb($data);
        redirect("autopaper/question","refresh");
    }
    else{
        redirect("autopaper/question","refresh");
...
public function edit_conversation()
  {
    if($this->uri->segment(3))
    {
      ...
      if($this->user_model->is_super())
              ...
              $this->load->view('header',$data);
              $this->load->view('sidebar',$data);
              $this->load->view('autopaper/edit_conversation',$data);    
    }
  }

//===================================================edit view of passage====================================
public function edit_passage()
  {
    if($this->uri->segment(3))
    {
      ...
      if($this->user_model->is_super())
              ...
              $this->load->view('header',$data);
              $this->load->view('sidebar',$data);
              $this->load->view('autopaper/edit_passage',$data);    
    }
  }

 //================================Save edit data of Make Sentence to Words===========================
public function save_edit_conservation()
{
     if($this->input->post()){
        $data = $this->input->post();
        $db_insert = $this->autopaper_model->save_edit_conservation($data);
        redirect("autopaper/question","refresh");
    }
    else{
        redirect("autopaper/question","refresh");
...
//================================Save edit data of Make Sentence to Words===========================
public function save_edit_passage()
{
     if($this->input->post()){
        $data = $this->input->post();
        $db_insert = $this->autopaper_model->save_edit_passage($data);
        redirect("autopaper/question","refresh");
    }
    else{
        redirect("autopaper/question","refresh");
...
public function  question_selection()
{
  ...
  public function get_question_print()
  {
    if($this->input->post())
    {
      ...
      $data['exam']= $this->db->query("SELECT name FROM `exam`  WHERE exam.is_delete='0'  AND id=$exam")->row_array();
...
public function edit_mf()
  {
    if($this->uri->segment(3))
    {
      ...
      if($this->user_model->is_super())
              ...
              $this->load->view('header',$data);
              $this->load->view('sidebar',$data);
              $this->load->view('autopaper/edit_mf',$data);    
    }
  }
  
  //================================Save edit data of masculine===========================
public function save_edit_mf()
{
     if($this->input->post()){
        $data = $this->input->post();
        $db_insert = $this->autopaper_model->save_edit_mf($data);
        redirect("autopaper/question","refresh");
    }
    else{
        redirect("autopaper/question","refresh");
