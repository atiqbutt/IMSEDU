              ...
              <div class="col-md-7 col-sm-6 col-xs-12 col-lg-offset-2">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url; ?>teacher/status_update" method="post">
                          ...
                          <select id="status" class="form-control col-md-7 col-xs-12" name="status" required="required">
                            <option value="">Select Status</option>
                             <?php 
                                ...
                                $satus=$this->db->get('status')->result();
                  ...
                  ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="teacher" class="form-control col-md-7 col-xs-12" name="teacher" required="required">
                            <option value="">Select Teacher</option>
                             <?php       
                                       $this->db->where('status',0)->where('branch',$branch) ;
                               $tea=$this->db->get('teacher')->result();
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo $base_url;?>teacher/rollback/<?php echo $value['id'];?>"><i class="fa fa-undo" aria-hidden="true"></i></a></td>
                     ...
                     <div class="row">
                      <div class="col-md-offset-8 col-sm-offset-8 col-md-4 col-sm-4 col-xs-12">
                        <div class="btn-group pull-right">
                            <button <?php if($curr==1){ ?>disabled<?php } ?> class="btn btn-success" data-href="<?php echo $base_url; ?>teacher/status/<?php echo $searchq.'/'.($curr - 1); ?>">
                                <i class="fa fa-arrow-left"></i>
                            </button>
                            <button class="btn btn-success" data-href="<?php echo $base_url; ?>teacher/status/<?php echo $searchq.'/'.$curr; ?>"><?php echo $curr; ?></button>
                            <button <?php if($curr==$end){ ?>disabled<?php } ?> class="btn btn-success" data-href="<?php echo $base_url; ?>teacher/status/<?php echo $searchq.'/'.($curr + 1); ?>">
  ...
  <script>
      $(function(){
        ...
        $(document).on("click","#go-search",function(e){
          ...
          if(s=="")
            s="all";
          window.location = "<?php echo base_url();?>teacher/status/"+s+"/"+p;
        });
