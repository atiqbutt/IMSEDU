              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>district/save" method="post">
                  ...
                  <?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input name="district" id="district" required="true" class="form-control">
                        </div>
                      </div>
 ...
 <div class="row">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody>
                        <?php $i=1; foreach ($district as  $value) { ?>
                        <tr>
                          <td><?php echo $i++; ?></td>
                          ...
                          <td>
                            ...
                            <a href='<?php echo base_url();?>district/edit/<?php echo $value['id']; ?>'><i class="fa fa-edit"></i></a> 
                            
                           <a href="<?php echo base_url();?>district/delete/<?php echo $value['id']; ?>" <i class="fa fa-trash"></i></a>
                          </td>
                          <?php } ?>
                        </tr>
                        <?php } ?>
                      ...
                      <div class="col-md-offset-8 col-sm-offset-8 col-md-4 col-sm-4 col-xs-12">
                        <div class="btn-group pull-right">
                            <button <?php if($curr==1){ ?>disabled<?php } ?> class="btn btn-success" data-href="<?php echo $base_url; ?>district/index/<?php echo $searchq.'/'.($curr - 1); ?>">
                                <i class="fa fa-arrow-left"></i>
                            </button>
                            <button class="btn btn-success" data-href="<?php echo $base_url; ?>district/index/<?php echo $searchq.'/'.$curr; ?>"><?php echo $curr; ?></button>
                            <button <?php if($curr==$end){ ?>disabled<?php } ?> class="btn btn-success" data-href="<?php echo $base_url; ?>district/index/<?php echo $searchq.'/'.($curr + 1); ?>">
...
<script>
      $(function(){
        $(document).on("click","#go-search",function(){
          ...
          if(s=="")
            s="all";
          window.location = "<?php echo base_url();?>district/index/"+s+"/"+p;
        });
