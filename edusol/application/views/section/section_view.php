                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <?php if(!$is_super){ ?>
                          <td>
                             <a href='<?php echo base_url();?>Section/edit/<?php echo $value['section_id']; ?>'><i class="fa fa-edit"></i></a>  
                         <a href='<?php echo base_url();?>section/delete/<?php echo $value['section_id'];?>'><i class="fa fa-trash"></i></a></td>
                          <?php } ?>
                        </tr>
                        <?php } ?>
                      </tbody>
                    ...
                    <div class="row">
                      <div class="col-md-offset-8 col-sm-offset-8 col-md-4 col-sm-4 col-xs-12">
                        <div class="btn-group pull-right">
                            <button <?php if($curr==1){ ?>disabled<?php } ?> class="btn btn-success" data-href="<?php echo $base_url; ?>section/index/<?php echo $searchq.'/'.($curr - 1); ?>">
                                <i class="fa fa-arrow-left"></i>
                            </button>
                            <button class="btn btn-success" data-href="<?php echo $base_url; ?>section/index/<?php echo $searchq.'/'.$curr; ?>"><?php echo $curr; ?></button>
                            <button <?php if($curr==$end){ ?>disabled<?php } ?> class="btn btn-success" data-href="<?php echo $base_url; ?>section/index/<?php echo $searchq.'/'.($curr + 1); ?>">
...
<script>
      $(function(){
        $(document).on("click","#go-search",function(){
          ...
          if(s=="")
            s="all";
          window.location = "<?php echo base_url();?>section/index/"+s+"/"+p;
        });
