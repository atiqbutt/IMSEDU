              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>section/save" method="post">
                  ...
                  <?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="section_name" class="form-control col-md-7 col-xs-12"  name="section_name" placeholder="Section Name" required="required" type="text" pattern="[A-Za-z]{1,10}" title="only Alphabatic letters">
