                ...
                <div class="super_wrapper">
                    <div class="wrapper left2 left">
                        <div class="header">
                            <div class="wd-100 clear">
                                ...
                                <div style="">
                                    ...
                                    <center><h3 class="boxed" style="margin-top:0px !important;font-size:23px;">Deadstock Report - <?php echo $deadstock[0]['branch_name']; ?></h3></center>
                                </div>
                            </div>
                            <div class="wd-100 clear">
                        ...
                        <div class="body">
                            ...
                            <?php $i=1; foreach($deadstock as $month => $value){ ?>
                                <tr>
                                    <td class="td"><?php echo $i++; ?></td>
                                    <td class="td"><?php echo $value['name']; ?></td>
                                    <td class="td"><?php echo $value['branch_name']; ?></td>
                                    <td class="td"><?php echo $value['quantity']; ?></td>
                                    <td class="td"><?php echo $value['amount']; ?></td>
