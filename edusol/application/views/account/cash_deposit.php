...
$pid=0;
 ...
 ?>
                    <form class="form-horizontal form-label-left" <?php if(!empty($values)){ echo "action=".base_url()."account/print_bank"; }else{ echo  "action=".base_url()."account/save_cash_deposit"; }  ?>  method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select <?php  if($values['bank_id']!=0){echo "disabled";} ?>  name="bank" id="bank" class="form-control" required>
                              ...
                              foreach ($bank as $value) {
                                ?>
                                <option <?php  if($value['id']==$values['bank_id']){echo "selected"; $account_no=$value['Account_no'];} ?>  value="<?php echo $value['id'];?>" data-acountno="<?php echo $value['Account_no']; ?>"><?php echo $value['b_name']." ".$value['b_code'];?></option>  
                                <?php
                              }  
                              ?>
                            </select>
                      ...
                      <div class="item form-group" id="ac_no">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Account no<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="date" <?php  if($values['bank_id']!=null){echo "value=".$account_no." disabled";} ?> disabled  id="acount_no" class="form-control date" maxlength="20" required>                    
                        </div>
                      </div> 
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Submit By<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="submit_by"  id="to" <?php  if($values['submit_by']!=null){echo "value=".$values['submit_by']." disabled";} ?> class="form-control abc" maxlength="20" required>                    
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Slip #<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="slip_no"  id="to" <?php  if($values['slip_no']!=null){echo "value=".$values['slip_no']." disabled";} ?> class="form-control num" maxlength="20" required>                    
                        </div>
                      </div>
                         <?php if(!empty($values)){}else{ ?>  
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pic">Slip Pic<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
...
<?php } ?>
                      ...
                      <input type="hidden" name="invoice_name" value="Cash Deposit">
                      <div class="col-md-6 col-md-offset-3">
...
<?php }
        ...
        var val=$("option:selected",this).attr("data-acountno");
        $('#ac_no').show();
        $('#acount_no').val(val);
         });
