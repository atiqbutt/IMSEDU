...
?>
 <?php 
 $ban=$this->db->select('title,Account_no')->from('bank_def')->where('id',$val['bank_id'])->get()->result_array()[0];
        ...
        <div class="wrapper left2 left">
           ...
           <div class="wd-100 left" style="line-height:3em;">
            ...
            <div class="wd-100 left" style="line-height:3em;">
                <div class="wd-100 clear">
                     <div class="wd-50 left">
                        <div class="wd-50 left"><h3>Bank Title</h3></div>
                        <div class="wd-50 left"><h4><?php echo $ban['title'];?></h4></div>
                    </div>
                <div class="wd-50 right">
                        <div class="wd-50 left"><h3>Account #</h3></div>
                        <div class="wd-50 left"><h4><?php echo $ban['Account_no']; ?></h4></div>
                </div>      
                </div>
            
                <?php if($title=="Cash Deposit"){$var="To"; $var2=$val['submit_by']; $var3="Slip #"; }
                     else  if($title=="Bank Payment"){$var="To"; $var2=$val['to_payment']; $var3="Cheque #";}
                     else  if($title=="Bank Receipt"){$var="From";  $var2=$val['from_recpt']; $var3="Cheque #"; } ?>
            </div>
...
<br/>
 <div class="wd-100 left" style="line-height:3em;">
                <div class="wd-100 clear">
                     <div class="wd-50 left">
                        <div class="wd-50 left"><h3><?php echo $var3; ?></h3></div>
                        <div class="wd-50 left"><h4><?php echo $val['cheque#'];?></h4></div>
                    </div>
...
<br/>
            <div class="wd-100 left" style="line-height:3em;">
                <div class="wd-100 clear">
                     <div class="wd-50 left">
                     <?php if($title=="Cash Deposit"){$var="To"; $var2=$val['submit_by']; }
                     else  if($title=="Bank Payment"){$var="To"; $var2=$val['to_payment'];}
                     else  if($title=="Cash Recipt"){$var="From";  $var2=$val['from_voucher']; }
                     else  if($title=="Bank Receipt"){$var="From";  $var2=$val['from_recpt']; } ?>
...
<br/>
            <div class="wd-100 left" style="line-height:3em;">
                ...
                <div class="wd-100 left">
                        <div class="wd-50 right"><h3>Signature :_______________________</h3></div>
                        <div class="wd-50 left"><h4></h4></div>
                </div>      
                </div>
