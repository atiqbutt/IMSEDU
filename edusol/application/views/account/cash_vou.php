              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left"  <?php if(!empty($values)){ echo "action=".base_url()."account/print_cash"; }else{ echo  "action=".base_url()."account/save_cash_voucher"; }  ?>  method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="from" <?php  if($values['from_voucher']!=null){echo "value=".$values['from_voucher']." disabled";} ?>  id="from" class="form-control abc" maxlength="20" required>                    
                        </div>
                      </div> 
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea  <?php  if($values['description']!=null){echo "disabled";} ?> name="description"  id="des" class="form-control abc"  required><?php if($values['description']!=null){echo $values['description'] ;} ?></textarea>                    
                        </div>
                      </div>  
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="amount" type="number" <?php  if($values['amount']!=null){echo "value=".$values['amount']." disabled";} ?>  id="amount" class="form-control" maxlength="20" required>                    
                        </div>
                      </div>
                      ...
                      <input type="hidden" name="invoice_name" value="Cash Receipt" >
                      <div class="col-md-6 col-md-offset-3">
