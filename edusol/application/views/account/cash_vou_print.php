                            ...
                            <div class="wd-100 clear">
                                ...
                                <div style="">
                                    ...
                                    <center><i><h3 style="color:#000 !important;font-weight:normal;"><?php echo $b_header['short_address']; ?></h3></i></center>
                                     <center><h3 style="color:#000 !important;"><i style="color:#000 !important;">Cash Reciept</i></h3></center>
                                  </div>
                            </div>
                          <br>
                        ...
                        <div class="body">
                            <table class="tbl1">
                                 <tr>
                                    ...
                                    <th class="th">Main Head</th>
                                    <th class="th">Head Level 2</th>
                                    <th class="th">Head Level 3</th>
                                    <th class="th">From</th>
                                ...
                                <tr>
                                        ...
                                        <td class="td"><?php echo $value['from_voucher'];  ?></td>
                                         <td class="td"><?php echo $value['description'];  ?></td>
                                        ...
                                        <td class="td"><?php echo $value['date'];  ?></td>          
                                            ...
                                            ?>
                                <tr>
                                    <td class="td text-right text-bold" colspan="7">Total:</td>
