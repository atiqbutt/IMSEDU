...
$pid=0;
 ...
 ?>
                    <form class="form-horizontal form-label-left"  method="POST" <?php if(!empty($values)){ echo "action=".base_url()."account/print_bank"; }else{ echo  "action=".base_url()."account/save_cash_payment"; }  ?>  enctype="multipart/form-data" >
...
<?php } ?>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="to" <?php  if($values['to_payment']!=null){echo "value=".$values['to_payment']." disabled";} ?> id="to" class="form-control abc" maxlength="20" required>                    
                        </div>
                      </div> 
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="cheque"  <?php  if($values['cheque#']!=null){echo "value=".$values['cheque#']." disabled";} ?>  id="" class="form-control num" maxlength="20" required>                    
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <input type="hidden" name="invoice_name" value="Bank Payment" >
                      <div class="col-md-6 col-md-offset-3">
