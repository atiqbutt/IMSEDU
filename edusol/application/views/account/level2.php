              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo base_url(); ?>account/save_level2" method="post">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody class="center">
                        ...
                        <tr>
                          ...
                          <td style="width:25%"><?php echo $value['mh_name']; ?></td>
