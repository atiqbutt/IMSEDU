                    ...
                    <div class="wrapper left2 left">
                            ...
                            <div class="wd-100 clear">
                                ...
                                <div style="">
                                    ...
                                    <center><i><h3 style="color:#000 !important;font-weight:normal;"><?php echo $b_header['short_address']; ?></h3></i></center>
                                     <center><h3 style="color:#000 !important;"><i style="color:#000 !important;">Bank Payment</i></h3></center>
                                  </div>
                            </div>
                          <br>
                        ...
                        <div class="body">
                            <table class="tbl1">
                                ...
                                <tr>
                                        <td class="td"><?php echo $offset++; ?></td>
                                        ...
                                        <td class="td"><?php echo $value['to_payment'];   ?></td>
