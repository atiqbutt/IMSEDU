             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="row">
                      ...
                      <br>
                  <!--<a href="<?php echo base_url().'Exam/printviewclass/'.$results_encoded; ?>" target="_blank">
      ...
      $(document).ready(function(){
            ...
            $(document).on('click', '#print', function() {
              ...
              if(program=='') {
                window.open("<?php echo base_url(); ?>"+"Account/cash_recipt_print/");
              }
               else if(program!='' && project!='' && main_head!='' && level2!='' && level3!='')
              {
                window.open("<?php echo base_url(); ?>"+"Account/cash_recipt_print/"+program+"/"+project+"/"+main_head+"/"+level2+"/"+level3);
              }
              else if(program!='' && project!='' && main_head!='' && level2!='')
              {
                window.open("<?php echo base_url(); ?>"+"Account/cash_recipt_print/"+program+"/"+project+"/"+main_head+"/"+level2);
              }
            else if(program!='' && project!='' && main_head!='' )
             {
               window.open("<?php echo base_url(); ?>"+"Account/cash_recipt_print/"+program+"/"+project+"/"+main_head);
             }
              else if(program!='' && project!='' ) {
                window.open("<?php echo base_url(); ?>"+"Account/cash_recipt_print/"+program+"/"+project);
              }
              else if(program!='') {
                window.open("<?php echo base_url(); ?>"+"Account/cash_recipt_print/"+program);
              }
            });
        ...
        $('#level2').change(function(){
         ...
         $('#program').change(function(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>Load_account/programe_against/"+id,
                    data: {},
                      success: function( d ) {
                          $("tbody.center").html(d);
  }
    ...
    $('#project').change(function(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>Load_account/project_against/"+id,
                    data: {},
                      success: function( d ) {
         ...
         $('#main').change(function(){
          ...
          var p=$('#program').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>Load_account/main_head_against/"+id+"/"+p,
                    data: {},
                      success: function( d ) {
...
$('#level2').change(function(){
          ...
          var m=$('#main').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>Load_account/level2_against/"+m+"/"+id+"/"+p,
                    data: {},
                      success: function( d ) {
...
$('#level3').change(function(){
          ...
          var l2=$('#level2').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>Load_account/level3_against/"+m+"/"+id+"/"+p+"/"+l2,
                    data: {},
                      success: function( d ) {
