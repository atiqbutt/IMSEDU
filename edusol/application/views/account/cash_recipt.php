...
$pid=0;
 ...
 ?>
                    <form class="form-horizontal form-label-left" <?php if(!empty($values)){ echo "action=".base_url()."account/print_cash"; }else{ echo  "action=".base_url()."account/save_cash_recipt"; }  ?>  method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="to"  id="to" <?php  if($values['to_receipt']!=null){echo "value=".$values['to_receipt']." disabled";} ?> class="form-control abc" maxlength="20" required>                    
                        </div>
                      </div> 
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" name="amount" <?php  if($values['amount']!=null){echo "value=".$values['amount']." disabled";} ?>  id="amount" class="form-control" maxlength="20" required>                    
                        </div>
                      </div>
                      ...
                      <input type="hidden" name="invoice_name" value="Cash Payment" >
                      <div class="col-md-6 col-md-offset-3">
