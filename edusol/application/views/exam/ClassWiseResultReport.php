                                ...
                                <tr>
									  ...
									  <th class="th">Position</th>
										...
										<tr>
											...
											<td class="td"><?php echo $value['class_name'];?></td>
											<td class="td"><?php echo $value['section_name'];?></td>
											<td class="td"><?php echo $value['Exam_name'];?></td>
											<td class="td"><?php echo $value['total_marks'];?></td>
											<td class="td"><?php echo $value['obtained_marks'];?></td>
