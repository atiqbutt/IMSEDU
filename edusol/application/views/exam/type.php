              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>exam/typeadd" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="name" id="name" required="required" class="form-control" placeholder="Name">
                        </div>
                      </div>                      
                      <div class="item form-group">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody>
                        <?php $i=1; foreach ($types as $k=>$value) { ?>
                        <tr>
                          <td><?php echo $i++; ?></td>
                          ...
                          <?php if(!$is_super){ ?>
                          <td>
                            <a href='<?php echo base_url();?>exam/typeedit/<?php echo $value['id']; ?>'><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url();?>exam/typedelete/<?php echo $value['id']; ?>" <i class="fa fa-trash"></i></a>
                          </td>
                          <?php } ?>
                        </tr>
                        <?php } ?>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <a href="<?php echo $base_url; ?>exam/type/<?php echo $i; ?>">
