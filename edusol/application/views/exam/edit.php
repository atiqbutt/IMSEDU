              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>exam/save" method="post">
                      <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Exam Name<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="name" value="<?php echo $data['name']; ?>" id="name" required="required" class="form-control" placeholder="Exam Name e.g First Term">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="start" value="<?php echo $data['start']; ?>" class="form-control col-md-7 col-xs-12"  type="date" name="start" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="end" value="<?php echo $data['end']; ?>" class="form-control col-md-7 col-xs-12"  type="date" name="end" required="required">
                        </div>
                      </div>
