          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Student Wise Fee History</h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url; ?>voucher/create_history" method="post">

                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="class">Student GR# <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="gr" class="form-control " id="gr" required >
                        </div>
                      </div>
    ...
    <script>
      $(function(){
        ...
        $(document).on("change","#class", function(){
          ...
          $.get("<?php echo base_url(); ?>load/check_voucher/"+val,{},function(ret){
            if(ret==1)
            $("#send").prop("disabled",true);
            else
