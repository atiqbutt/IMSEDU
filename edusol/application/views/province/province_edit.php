              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>province/update" method="post">
                    ...
                    <?php       $this->db->where('is_delete',0) ;
                              ...
                              foreach ($com as $value1) {
                  ?>
                    <option value="<?php echo $value1->country_id; ?>"><?php echo $value1->country_name?></option>
                  ...
                  <?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="hidden" name="id" value="<?php echo $value->province_id;?>">
                          <input name="province" id="province" required="true" class="form-control" value="<?php echo $value->province_name;?>">
                        </div>
                      </div>
                     <?php } ?> 
