       <?php //var_dump($coster);die(); ?>
        <!-- page content -->
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Adjust Arrears</h3>
                </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <form class="form-horizontal form-label-left" action="<?php echo base_url();?>Voucher/getArrearStudent" method="post" id="form1">
                      
                       <span class="col-lg-12 bg-success text-success" id="success" style="margin-bottom:5px;padding:5px;<?php if($success==true) echo 'display:block;';else echo 'display:none;'; ?>">Arrears successfully applied</span>
