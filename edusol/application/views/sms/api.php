              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url; ?>sms/api/add" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="API Name" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="code" class="form-control col-md-7 col-xs-12" name="code" placeholder="API Code" required="required" type="text">
                        </div>
                      </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody>
                        <?php $i=1; foreach ($api as $key => $value) { ?>
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $value['name']; ?></td>
                            <td><?php echo $value['code']; ?></td>
                            <td>
                                <a href="<?php echo $base_url; ?>sms/api/edit/<?php echo $value['id']; ?>"><i class="fa fa-edit"></i></a> 
                                <a href="<?php echo $base_url; ?>sms/api/delete/<?php echo $value['id']; ?>"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <a href="<?php echo $base_url; ?>sms/api/manage/<?php echo $i; ?>">
