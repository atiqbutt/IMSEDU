                    ...
                    <div class="wrapper left2 left">
                                ...
                                <div class="wd-80 left">
                                    ...
                                    <div class="wd-100 clear">
                                        <div class="wd-50 left">
                                                ...
                                                <div class="wd-50 left"><h6><?php echo date("d-m-Y",strtotime($result['start']));?> To <?php echo date("d-m-Y",strtotime($result['end']));?></h6></div>
                                        </div>
                                    </div>
                                </div>  
                        ...
                        <div class="body">
                            <table class="tbl1">
                                ...
                                <?php $serial=1;$re=0;$to=0; foreach ($result_subject as $key => $res) { ?>
                                <tr>
                                    ...
                                    <td class="td"><?php if($res['obtained_marks']=="A") { echo "Fail";} else if($res['obtained_marks']>$res['passing_marks']){ echo "Pass";} else { echo "Fail";}?></td>
                                </tr>
                                <?php } ?>
                            </table>
                            <div class="wd-100 clear">
                                <div class="wd-40 left">
                                    ...
                                    <div class="wd-50 left"><h4><?php echo $result['total_marks'];?></h4></div>
                                </div>
                            ...
                            <div class="wd-100 clear">
                                <div class="wd-40 left">
                                    ...
                                    <div class="wd-50 left"><h4><?php echo $result['obtained_marks'];?></h4></div>
                                </div>
                                <div class="wd-50 left">
                                    <div class="wd-50 left"><h3 class="text-left">Position:</h3></div>
                                    <div class="wd-50 left"><h4><?php echo $result['position'];?></h4></div>
                                </div>
                            </div>
                            <div class="wd-100 clear">
                                <div class="wd-40 left">
                                    <div class="wd-50 left"><h3 class="text-left">Marks %:</h3></div>
                                    <div class="wd-50 left"><h4><?php echo round( ($result['obtained_marks'] / $result['total_marks']) * 100, 1)."%";?></h4></div>
                                </div>
                                <div class="wd-50 left">
                                    <div class="wd-50 left"><h3 class="text-left">Attendance %:</h3></div>
                                    <div class="wd-50 left"><h4><?php echo $result['attendance'];?></h4></div>
                                </div> 
                            </div> 
                            <div class="wd-100 clear">
