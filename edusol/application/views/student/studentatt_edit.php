                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url; ?>student/saveatt" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" value="<?php echo $studentatt['date']; ?>" class="form-control col-md-7 col-xs-12 date" data-validate-length-range="6" data-validate-words="2" name="date" placeholder="Attendance Date" required="required" type="text">
                       <input id="studentattid" name="studentattid" value="<?php echo $studentatt['id']; ?>" type="hidden" />
                        </div>
                      </div>
                     ...
                     <tr>
                          ...
                          <th style="width:60px;">Student Name</th>
                     ...
                     <td><?php echo $studentatt['grno'];?></td>
                      <td><?php echo $studentatt['roll_no'];?></td>
                      <td><?php echo $studentatt['student_name'];?></td>
                      <td><?php echo $studentatt['class_name'];?></td>
                      <td><?php echo $studentatt['section_name'];?></td>
                    ...
                    foreach ($statusid as $key => $value) {
                      ...
                      ?>
                    <input type="radio" name="status" <?php if($studentatt["status_id"]==$value['id']){echo "checked";}  ?> value="<?php echo $value['id']; ?>"/><?php echo $value['status']; ?>
                  <?php }  ?> 
