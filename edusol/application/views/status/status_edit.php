...
?> 
                      <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>status/status_update" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" value="<?php echo $values->name;?>" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="Status Name" required="required" type="text">
                        </div>
                      </div>
