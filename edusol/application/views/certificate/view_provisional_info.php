          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> View Provisional Information</h2>
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody>
                        <?php $i=1; foreach ($leave as $key => $value) { ?>
                        <tr>
                          <td><?php echo $i++; ?></td>
                          ...
                          <?php if(!$is_super){ ?>
                          <!-- <td>
                            <a href='<?php echo base_url();?>certificate/view_leave/<?php echo $value['id']; ?>'><i class="fa fa-edit"></i></a> 
                          </td>
 -->                          <?php } ?>
                        </tr>
                        <?php } ?>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <a href="<?php echo $base_url; ?>certificate/provisional_view/<?php echo $i; ?>">
