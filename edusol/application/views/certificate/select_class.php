          ...
          <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Select Class and Certificate</h3>
                </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>certificate/select_class" method="post">
                  ...
                  <?php } ?>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Certificate <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="certificate" name="certificate" class="form-control" required>
                            <option value="">Select Certificate</option>
                             <?php       
                                ...
                                $cer=$this->db->get('certificate')->result();
                              foreach ($cer as $value1) {
                  ?>
                  ...
                  <?php } ?>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">For <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="for_student" name="for_student" class="form-control" required>
                            <option value="">Select Student Types</option>
                            <option value="active">For Active students</option>
                            <option value="deactive">For Deactive students</option>
                          </select>
                        </div>
                      </div>
