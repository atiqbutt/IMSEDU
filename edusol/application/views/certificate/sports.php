        ...
        <div class="wrapper">
            <div class="header">
                ...
                <div class="right wd-90">
                    ...
                    <h2><?php echo $b_header['tagline']; ?></h2>
                    <h1 class="cert">SPORTS CERTIFICATE</h1>
                </div>
            </div>
            <div class="body">
                <div class="row clear">
                ...
                <div class="row clear">
                    <div class="left wd-33">
                        <p class="bold">This is to certify that Mr. / Miss:</p>
                    </div>
                    <div class="right wd-67 b-u-l text-center hg-inht">
                ...
                <div class="row bold">
                    He/She took keen interest in co-curricular activities.
                </div>
                <div class="row bold">
                    He/She was player of In door/Out door games of this school.
                </div>
               <div class="right">
 <div class="row">&nbsp;</div>
 <div class="row b-u-l">&nbsp;</div> <div class="row text-center bold">
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Principal
                        </div>
