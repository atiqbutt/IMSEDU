                  ...
                  <div class="x_content">
                      <table class="table table-striped table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $i;?></td>
                            <td style="text-size:bold;"><?php echo $cer->name?></td>
                            <td>
                              <?php 
                              if($cer->is_active==1)
                                {
                                  ?>
                                  <a href="<?php echo base_url();?>certificate/deactive/<?php echo $cer->id;?>"><i class="fa fa-lg fa-times-circle" style="color:red;">Deactive</i></a>
                            <?php } else if($cer->is_active==0){?><a href="<?php echo base_url();?>certificate/active/<?php echo $cer->id;?>"><i class="fa fa-lg fa-times-circle">Active</i></a>
                            <?php } ?>
                            </td>
                          </tr>
                          <?php  $i++; } ?>
