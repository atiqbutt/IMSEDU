                  ...
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $value['conduct']; ?></td>
                          <td><?php echo $value['progress']; ?></td>
                          
                          <td><?php echo date("d-m-Y",strtotime($value['dol'])); ?></td>
                          <?php if(!$is_super){ ?>
                          <!-- <td>
                            <a href='<?php echo base_url();?>certificate/edit_leave_info/<?php echo $value['id']; ?>'><i class="fa fa-edit"></i></a> 
                          </td> -->
                          <?php } ?>
                        </tr>
                        <?php } ?>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <a href="<?php echo $base_url; ?>certificate/view_leave/<?php echo $i; ?>">
