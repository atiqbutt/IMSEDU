            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="<?php echo base_url(); ?>Exam/edit_note" class="form-horizontal form-bordered" method="post">
                 ...
                 <div class="form-group">
                        <label class="col-md-3 control-label" for="inputSuccess">Select Note</label>
                        <div class="col-md-6">
