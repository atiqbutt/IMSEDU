          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Select Class For Datesheet</h2>
                  ...
                  <div class="x_content">
                     ...
                     <form action="<?php echo base_url(); ?>Exam/date1" class="form-horizontal form-bordered" method="post">
            ...
            <div class="row">
                                        <button class="btn btn-primary col-lg-offset-8" type="submit" name="submit">Submit</button>
                                        </div>  
