                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
								<table class="table table-bordered table-stripped">
									<thead>
										<tr><th>#</th><th>Class Name</th><th>subject Name</th><th>Exam Name</th><th>Date</th><th>Action</th>
                    </tr>
									</thead>
									<tbody>
                    ...
                    <td>
                      <a href="<?php echo base_url(); ?>Exam/edit1/<?php echo $v['datesheet_id']; ?>"><i class="fa fa-pencil-square-o"></i></a>
                      <a href="<?php echo base_url(); ?>Exam/delete1/<?php echo $v['datesheet_id']; ?>"><i class="fa fa-trash"></i></a>
                    </td>
                    <tr>
                    <?php } ?>
                  </tbody>
