 ...
 <!-- page content -->
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Allowance Type<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                        <select name="allonce" id="allonce" class="form-control">
                        <option value="">Select Allowance</option>
                        <?php foreach ($allonce as $key => $value) { ?>
                            <option value="<?php echo $value['id']; ?>" data-amount="<?php echo $value['amount'] ?>"><?php echo $value['name']; ?></option>
                        <?php } ?>
                        </select>
                           </div>
                      </div>
                    ...
                    <form action="<?php echo base_url(); ?>salary/saveasignalloance/" method="post" >
        ...
        $('#send').click(function(){
            ...
            var allonceid=$("#allonce").val();
            var alloncename=$("#allonce option:selected").html();
            var amount= $("#ammount").val();
            var month= $("#month").val();
            console.log(type,id,name,allonceid,alloncename,amount);
            if(type!='' && id!='' && name!='' && allonceid!='' && alloncename!='' && amount!='' && month!='') {
                $("#table_body").append("<tr data-row='"+(++entry_id)+"'>"+
                    ...
                    "<td>"+alloncename+"<input type='hidden' name='entry["+entry_id+"][allowance][id]' value='"+allonceid+"'></td>"+
                    "<td>"+amount+"<input type='hidden' name='entry["+entry_id+"][allowance][amount]' value='"+amount+"'></td>"+
                    "<td>"+month+"<input type='hidden' name='entry["+entry_id+"][allowance][month]' value='"+month+"'></td>"+
        ...
        function clearSearch()
        {
            ...
            $("#searchid").val("");
            $("#searchv").val("");
            $("#allonce option[value='']").prop("selected","selected");
            $("#ammount").val("");
            $("#month").val("");
        }
