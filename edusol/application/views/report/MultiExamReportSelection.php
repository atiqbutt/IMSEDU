              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>Report/MultiExamReportList" method="post">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="hidden" name="exams[]" value="">
                          <div id="exam_wrapper" class="">
                           <div class="form-control">Select Class First</div>
                          </div>
                        </div>
                      </div>
...
<script>
        ...
        $(document).ready(function(){
            $(document).on("change",".class",function(){
                ...
                $.get("<?php echo base_url(); ?>load/exam_json/"+value,{},function(d){
                    var exams = "";
                    if(d!="")
                    {
                        ...
                        if(data.length==0)
                        {
                            exams = '<div class="form-control">No Class Found</div>';
                        }else{
                            $.each(data,function(i,v){
                                exams += '<div class="form-control"><input type="checkbox" name="exams[]" value="'+v.id+'"> '+v.name+'</div>';
                            });
                        }
                    }else{
                        exams = '<div class="form-control">No Class Found</div>';
                    }
                    $("#exam_wrapper").html(exams);
                });
            });
        });
    </script>