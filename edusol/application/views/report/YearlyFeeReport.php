                        ...
                        <div class="header">
                            <div class="wd-100 clear">
                                ...
                                <div style="">
                                    ...
                                    <center><h3 class="boxed" style="margin-top:0px !important;font-size:23px;">Yearly Fee Report - <?php echo date('Y',strtotime(key($monthly_values))); ?></h3></center>
                                </div>
                            </div>
                            <div class="wd-100 clear">
                        ...
                        <div class="body">
                            <table class="tbl1">
                                <tr>
                                    ...
                                    <th class="th">Total Expected fee</th>
                                    <th class="th">Total Fee Recieved</th>
                                    <th class="th">Total Fee Remaining</th>
                                    <th class="th">Total Expense</th>
                                </tr>
                            <?php $i=1; foreach($monthly_values as $month => $value){ ?>
                                <tr>
                                    <td class="td"><?php echo $i++; ?></td>
                                    <td class="td"><?php echo date('F-Y',strtotime($month)); ?></td>
                                    <td class="td"><?php echo round($value['total_fee']); ?></td>
                                    <td class="td"><?php echo round($value['fee_recieved']); ?></td>
                                    <td class="td"><?php echo round($value['fee_remaining']); ?></td>
                                        ...
                                        <strong>
                                            <?php 
                                                ...
                                                foreach ($monthly_values as $month => $value) {
                                                    $grand_total_expected+=$value['total_fee'];
                                                }
                                                echo round($grand_total_expected);
                                            ?>
                                        </strong>
                                     </td>
                                     <td>
