...
<div class="" style="width:40%;margin:0 auto;">
  ...
  <div class="panel panel-info center-block">
    ...
    <div class="panel-body">
        <form class="form-horizontal" action="<?php echo base_url(); ?>SmsHajana/sendOneNumber" method="post">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Number</label>
                <div class="col-sm-10">
                    <input type="text" name="number" class="form-control" placeholder="923344339575" pattern="^(92)[0-9]{10}" title="Like: 923344339575" required>
                </div>
            </div>
            <div class="form-group">
