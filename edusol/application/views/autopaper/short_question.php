        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_short_question" method="post">
...
<label class="control-label col-md-3 col-sm-3 col-xs-3" for="name">Question<span class="required">*</span>
                                    ...
                                    <div class="row row1">
                                        <div class="col-md-10 col-xs-10 col-sm-10">
                                          <!--<input type="text" class="form-control" name="question[]" placeholder="Question">-->
                                            <textarea rows="1"  class="form-control" name="question[]"></textarea>
                                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button type="button" onclick="CKEDITOR.tools.callFunction(55,this);" class="btn btn-info"><span class="fa fa-pencil"></span> Type maths</button>
                        </div>
                      </div>
                    </form>
                  </div>
...
<script>
            ...
            var sec=$("#section").val(); 
                ...
                $.get("<?php echo base_url(); ?>load/subject_section/"+c+"/"+sec,{},function(d){
...
<script type="text/javascript">
        $('#class').change(function(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>load/questionagainstclass/"+id,
                    data: {},
...
//==============================on change of subject=========================
        $('.sub').change(function(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>load/questionagainstsubject/"+id+"/"+idsub,
                    data: {},
                      success: function(result){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
//======================on change of chapter===============================================
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>load/questionagainstchpter/"+id+"/"+idsub+"/"+idchap,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
//==============================on change of level=========================================
          ...
          var idchap=$('#chapter').val();
            console.log(level);
          $.ajax({
                    url: "<?php echo base_url(); ?>load/questionagainstlevel/"+id+"/"+idsub+"/"+idchap+"/"+level,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
