        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_long_question" method="post">
...
<script type="text/javascript">
        $('#class').change(function(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>load/long_questionagainstclass/"+id,
                    data: {},
        ...
        $('.sub').change(function(){
          ...
          var idsub=$(this).val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/long_questionagainstsubject/"+id+"/"+idsub,
                    data: {},
                      success: function(result){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
        ...
        $('#chapter').change(function(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>load/long_questionagainstchpter/"+id+"/"+idsub+"/"+idchap,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
  ...
  //==============================on change of level=========================================
          ...
          var idchap=$('#chapter').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/longquestionagainstlevel/"+id+"/"+idsub+"/"+idchap+"/"+level,
                    data: {},
                      success: function( result ){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
