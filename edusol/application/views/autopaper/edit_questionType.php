              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/update_question_type" method="post">
                  ...
                  <?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input name="name" id="name" required="true" class="form-control" placeholder="Question Type Name" value="<?php echo $name;?>">
                          <input type="hidden" name="id" id="id" required="true" class="form-control" placeholder="Question Type Name" value="<?php echo $id;?>">
                        </div>
                      </div>
                      <div class="item form-group">
