        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/GeneralQuestion" method="post">
                      ...
                      <div class="item form-group" id="subject_div">
...
<script type="text/javascript">
        $('#class').change(function(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>load/fill_questionagainstclass/"+id+"/"+4,
                    data: {},
        ...
        $('.sub').change(function(){
          ...
          var idsub=$(this).val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/fill_questionagainstsubject/"+id+"/"+idsub+"/"+4,
                    data: {},
                      success: function(result){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>load/fill_questionagainstchapter/"+id+"/"+idsub+"/"+idchap+"/"+4,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
          ...
          var idchap=$('#chapter').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/fill_questionagainstlevel/"+id+"/"+idsub+"/"+idchap+"/"+level+"/"+4,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
