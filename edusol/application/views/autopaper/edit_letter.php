            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
          <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_edit_letter" method="post">
                         ...
                         <div id="keyword_wrapper" class="col-md-7 col-sm-7 col-xs-7">
                                    <div class="row row1">
                                        <div class="col-md-10 col-xs-10 col-sm-10">
                                            <input type="text" class="form-control" name="question" value="<?php echo $val['letter'];?>">
                                        </div>
                                    </div>
                                </div>
