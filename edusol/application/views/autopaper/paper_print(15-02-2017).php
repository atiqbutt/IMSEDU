           ...
           foreach ($query_print as $value) {          
            $question=$value['paragraph'];
                ?>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['paragraph_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php 
            } ?>
                  </div>  
           ...
           foreach ($query_print as $value) {          
            $question=$value['letter'];
                ?>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['letter_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php 
            } ?>
                  </div>  
...
<?php  if(!empty($data['short']) && !empty($data['short_marks']) ){
 ...
 foreach($chapter as $key=> $chap){
     ...
     if($c>0)  { 
      ...
      $this->db->select('short_questions.question');
           ...
           $query_print=$this->db->where('short_questions.level',$level)->order_by('rand()')->limit($short_limit)->get()->result_array();
           //var_dump("<pre>",$query_print);die();
           foreach ($query_print as $value) {
                  $question=$value['question'];
            ?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><b>&nbsp;Q&nbsp;<?php echo $k++; ?>:</b> <?php echo $value['question'];?></div>
...
?>
         <div class="row">
              <div class="col-md-11 col-sm-11 col-xs-11 col-md-offset-1">
                     <h3><?php echo $data['opposites_tag']; ?></h3>
                  <div class="row">
      <?php 
      $k=1;
      ...
      $this->db->select('opposites');
          $this->db->from('general_questions');
           ...
           foreach ($query_print as $value) {
            ...
            ?>
                        <div class="col-md-11 col-sm-11 col-xs-11"<br/>Q2.<?php echo $k++; ?>:<b> <?php echo $value['opposites'];?></b></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['opposites_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
                          <?php } ?>
                  </div>  
              </div>
...
<?php  if(!empty($data['wordsmeanings']) && !empty($data['wordsmeanings_marks']) ){
     ...
     if($c>0)  { ?>
       <div class="row">
              <div class="col-md-11 col-sm-11 col-xs-11 col-md-offset-1">
                     <h3><?php echo $data['wm_tag']; ?> <span style="float:right; font-size: 14;font-weight: bold;margin-right:50px;"> ( <?php echo $data['wordsmeanings']*$data['wordsmeanings_marks']; ?>)</h3>
                  <div class="row">
<?php 
      $k=1;
      $wm_limit=$data['wordsmeanings'];
           ...
           $query_print=$this->db->where('is_delete',0)->order_by('rand()')->limit($wm_limit)->get()->result_array();
                  foreach ($query_print as $value) {
                        ...
                        ?>
                        <div class="col-md-3 col-sm-3 col-xs-3"><?php echo $k++; ?>:<b> <?php echo $value['words'];?></b></div>
          ...
          <div class="row">
           ...
           $query_print=$this->db->where('is_delete',0)->order_by('rand()')->limit($fill_limit)->get()->result_array();
                 foreach ($query_print as $value) {          
                        ...
                        ?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><span class="question"><?php echo $j++;?>:</span> <b> <?php echo $value['fill_blank_question'] ;?></b></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['fill_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php } ?>
                  </div>  
              </div>
          ...
          <div class="row">
           ...
           foreach ($query_print as $value) {          
                  $question=$value['true_words']; ?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><span class="question"><?php echo $j++;?>:</span> <b> <?php echo $value['true_words'] ;?></b></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['truefalse_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php } ?>
                  </div>  
              </div>
          ...
          <div class="row">
           ...
           foreach ($query_print as $value) {          
                  $question=$value['superlative'];?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><span class="question"><?php echo $j++;?>:</span> <b> <?php echo $value['superlative'] ;?></b></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['superlative_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php } ?>
                  </div>  
              </div>
...
<?php  if(!empty($data['ideoms']) && !empty($data['ideoms_marks']) ){
          ...
          <div class="row">
              <div class="col-md-11 col-sm-11 col-xs-11 col-md-offset-1">
                    <h3><?php echo $data['ideoms_tag']; ?></h3>
                  <div class="row" style="line-height:2;">
            <?php
           ...
           foreach ($query_print as $value) {          
                  $question=$value['superlative'];?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><span class="question"><?php echo $j++;?>:</span> <b> <?php echo $value['ideoms'] ;?></b></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['ideoms_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php } ?>
                  </div>  
              </div>
          ...
          <div class="row">
           ...
           foreach ($query_print as $value) {          
                  $question=$value['wordforsentence'];?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><span class="question"><?php echo $j++;?>:</span> <b> <?php echo $value['wordforsentence'] ;?></b></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['makesentence_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php } ?>
                  </div>  
              </div>
...
?>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['translateintoenglish_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php } ?>
                  </div>  
              </div>
...
<?php  if(!empty($data['centeralidea']) && !empty($data['centeralidea_marks']) ){
          ...
          <div class="row">
           ...
           foreach ($query_print as $value) {          
            ...
            ?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><span class="question"><?php echo $j++;?>:</span> <b> <?php echo $value['centeral_idea'] ;?></b></div>
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['centeralidea_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
            <?php } ?>
                  </div>  
              </div>
...
<?php 
           ...
           $question=$value['question'];
?>
                        <div class="col-md-11 col-sm-11 col-xs-11"><?php echo $k++; ?>:<b> <?php echo $value['question'];?></b></div>
     ...
     if($c>0) { ?>            
           ...
           foreach ($query_print as $value) {
                ...
                ?>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['poem_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
                          <?php } ?>
                  </div>  
              </div>
...
<?php  if(!empty($data['essay']) && !empty($data['essay_marks']) ){
         ...
         // var_dump($query_print);die();
                ...
                ?>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-1"><b>(<?php echo $data['essay_marks'] ;?>)</b></div>
                        <div class="clearfix"></div>
                          <?php }?>
                  </div>  
              </div>
