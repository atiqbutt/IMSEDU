        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_Poem_question" method="post">
...
<label class="control-label col-md-3 col-sm-3 col-xs-3" for="name">Poem<span class="required">*</span>
                        </label>
                         <div id="keyword_wrapper" class="col-md-7 col-sm-7 col-xs-7">
                                    <div class="row row1">
                                        <div class="col-md-10 col-xs-10 col-sm-10">
                                            <input type="text" class="form-control" name="question[]" placeholder="type here Poem ?">
                                        </div>
                    ...
                    $("#chapter").html(pre+d);
                                ...
                                $(function(){
                                    ...
                                    var Dnew = '<div class="row row{id}">' +
                                        '<div class="col-md-10 col-xs-10 col-sm-10">' +
                                            '<input type="text" class="form-control" name="question[]" placeholder="Poem Question">' +
                                        '</div>' +
                                        '{action}' +
                                    '</div>';
...
//=========================================Class wise load======================================
       $('#class').change(function(){
         var id=$('#class').val();
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/poem_questionagainstclass/"+id+"/"+10,
                   data: {},
...
//========================================Subject wise load====================================
        $('.sub').change(function(){
          ...
          var idsub=$(this).val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/poem_questionagainstsubject/"+id+"/"+idsub+"/"+10,
                    data: {},
                      success: function(result){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
//=======================================chapter wise load================================================
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/poem_questionagainstchapter/"+id+"/"+idsub+"/"+idchap+"/"+10,
                   data: {},
                     success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
$('#level').change(function(){
          ...
          var idchap=$('#chapter').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/poem_questionagainstlevel/"+id+"/"+idsub+"/"+idchap+"/"+level+"/"+10,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
