          ...
          <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Words Meanings Questions</h3>
                </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Words Meanings Question</h2>
           ...
           <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_words_meanings" method="post">
...
<label class="control-label col-md-3 col-sm-3 col-xs-3" for="name">Words/Meanings<span class="required">*</span>
                        </label>
                         <div id="keyword_wrapper" class="col-md-7 col-sm-7 col-xs-7">
                                    <div class="row row1">
                                        <div class="col-md-5 col-xs-5 col-sm-5">
                                            <input type="text" class="form-control" name="question[]" placeholder="Words ?">
                                        </div>
                                        <div class="col-md-5 col-xs-5 col-sm-5">
                                            <input type="text" class="form-control" name="question1[]" placeholder="Meanings ?">
                                        </div>
...
//=========================================Class wise load======================================
       $('#class').change(function(){
         var id=$('#class').val();
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/wm_questionagainstclass/"+id+"/"+16,
                   data: {},
...
//========================================Subject wise load====================================
        $('.sub').change(function(){
          ...
          var idsub=$(this).val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/wm_questionagainstsubject/"+id+"/"+idsub+"/"+16,
                    data: {},
                      success: function(result){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
//=======================================chapter wise load================================================
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/wm_questionagainstchapter/"+id+"/"+idsub+"/"+idchap+"/"+16,
                   data: {},
                     success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
$('#level').change(function(){
          ...
          var idchap=$('#chapter').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/wm_questionagainstlevel/"+id+"/"+idsub+"/"+idchap+"/"+level+"/"+16,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
