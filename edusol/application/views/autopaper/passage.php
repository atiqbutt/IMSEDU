        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_passage" method="post">
         ...
         <label class="control-label col-md-3 col-sm-3 col-xs-3" for="name">Passage<span class="required">*</span>
                        </label>
                         <div id="keyword_wrapper2" class="col-md-7 col-sm-7 col-xs-7">
                                    <div class="row row1">
                                        <div class="col-md-10 col-xs-10 col-sm-10">
                                       
                  <textarea style="padding: 10px;vertical-align: top;width: 500px;" rows="2" name="passg" placeholder="Tpye here paragraph ?" cols="100"></textarea>
                                        </div>
                         ...
                         <div id="keyword_wrapper" class="col-md-7 col-sm-7 col-xs-7">
                                    <div class="row row1">
                                        <div class="col-md-10 col-xs-10 col-sm-10">
                                         <input type="text"  class="form-control" name="question[]" placeholder="Tpye here  Question?">
                    ...
                    $("#chapter").html(pre+d);
                                ...
                                $(function(){
                                    ...
                                    var Dnew = '<div class="row row{id}">' +
                                        '<div class="col-md-10 col-xs-10 col-sm-10">' +
                                            '<input type="text" class="form-control" name="question[]" placeholder="type here question">' +
                                        '</div>' +
                                        '{action}' +
                                    '</div>';
...
//=========================================Class wise load======================================
       $('#class').change(function(){
         var id=$('#class').val();
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/passage_questionagainstclass/"+id+"/"+24,
                   data: {},
...
//========================================Subject wise load====================================
        $('.sub').change(function(){
          ...
          var idsub=$(this).val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/passage_questionagainstsubject/"+id+"/"+idsub+"/"+24,
                    data: {},
                      success: function(result){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
//=======================================chapter wise load================================================
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/passage_questionagainstchapter/"+id+"/"+idsub+"/"+idchap+"/"+24,
                   data: {},
                     success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
$('#level').change(function(){
          ...
          var idchap=$('#chapter').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/passage_questionagainstlevel/"+id+"/"+idsub+"/"+idchap+"/"+level+"/"+24,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
