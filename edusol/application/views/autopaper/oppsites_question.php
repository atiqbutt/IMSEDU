        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_Opposites_question" method="post">
...
<label class="control-label col-md-3 col-sm-3 col-xs-3" for="name">Opposites/Answers<span class="required">*</span>
                        </label>
                         <div id="keyword_wrapper" class="col-md-7 col-sm-7 col-xs-7">
                                    <div class="row row1">
                                        <div class="col-md-5 col-xs-5 col-sm-5">
                                            <input type="text" class="form-control" name="question[]" placeholder="Opposites?">
                                        </div>
                                        <div class="col-md-5 col-xs-5 col-sm-5">
                                            <input type="text" class="form-control" name="question1[]" placeholder="Answers?">
                                        </div>
...
//=========================================Class wise load======================================
       $('#class').change(function(){
         var id=$('#class').val();
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/opposites_questionagainstclass/"+id+"/"+12,
                   data: {},
...
//========================================Subject wise load====================================
        $('.sub').change(function(){
          ...
          var idsub=$(this).val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/opposites_questionagainstsubject/"+id+"/"+idsub+"/"+12,
                    data: {},
                      success: function(result){
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
//=======================================chapter wise load================================================
          ...
          $.ajax({
                   url: "<?php echo base_url(); ?>load/opposites_questionagainstchapter/"+id+"/"+idsub+"/"+idchap+"/"+12,
                   data: {},
                     success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
...
$('#level').change(function(){
          ...
          var idchap=$('#chapter').val();
          $.ajax({
                    url: "<?php echo base_url(); ?>load/opposites_questionagainstlevel/"+id+"/"+idsub+"/"+idchap+"/"+level+"/"+12,
                    data: {},
                      success: function( result ) {
                            $("#datatable-buttons").dataTable().fnDestroy();
                            setTimeout(function(){ 
