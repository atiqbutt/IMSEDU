          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Update Words Meanings Question</h2>
            ...
            <form class="form-horizontal form-label-left" action="<?php echo $base_url;?>autopaper/save_edit_wm" method="post">
                         ...
                         <div id="keyword_wrapper" class="col-md-7 col-sm-7 col-xs-7">
                                    <div class="row row1">
                                        <div class="col-md-5 col-xs-5 col-sm-5">
                                            <input type="text" class="form-control" name="question" placeholder="Words ?" value="<?php echo $val['words'];?>">
                                        </div>
                                        <div class="col-md-5 col-xs-5 col-sm-5">
                                            <input type="text" class="form-control" name="question1" placeholder="Meanings ?" value="<?php echo $val['meanings'];?>">
                                        </div>
                                    </div>
                                </div>
