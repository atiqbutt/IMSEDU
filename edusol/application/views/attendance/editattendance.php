              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo $base_url; ?>Teacherattendancecr/save" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" value="<?php echo $teacheratt['date']; ?>" class="form-control col-md-7 col-xs-12 date" data-validate-length-range="6" data-validate-words="2" name="date" placeholder="Attendance Date" required="required" type="text">
                       <input id="editteacherid" name="editteacherid" value="<?php echo $teacheratt['id']; ?>" type="hidden" />
                        </div>
                      </div>
                     ...
                     <td><?php echo $teacheratt['firstname']." ".$teacheratt['lastname'];?></td>
                     <td><?php echo $teacheratt['specialization'];?></td>
                    <td><?php echo $teacheratt['contact'];?></td>
                    <td> 
                    <?php
                    foreach ($statusid as $key => $value) {
                    
                      ?>
                    <input type="radio" name="status" <?php if($teacheratt["statusid"]==$value['id']){echo "checked";}  ?> value="<?php echo $value['id']; ?>"/><?php echo $value['status']; ?>
                  <?php }  ?> 
